...
unit2014= pd.read_csv("/home/mint/my-data/Web_scraped_CPI/Code_upgrade/data/unit2014.csv")
unit2015= pd.read_csv("/home/mint/my-data/Web_scraped_CPI/Code_upgrade/data/unit2015.csv")
unit2016= pd.read_csv("/home/mint/my-data/Web_scraped_CPI/Code_upgrade/data/unit2016.csv")
...
def singlechainlink(originalyear, chainedyear,chainedyear2, basedate,basedate2,freq,priceindex):
    ...
    aaa15.columns=["Unnamed: 0", "Unnamed: 1", "Unnamed: 2",priceindex,"i","ons_item_name","period"]
    ...
    aaa16.columns=["Unnamed: 0", "Unnamed: 1","Unnamed: 2", "Unnamed: 3","Unnamed: 4", "ons_item_number", "period","i",priceindex,"ii"]
    del aaa16["Unnamed: 0"]
    del aaa16["Unnamed: 1"]
    del aaa16["Unnamed: 2"]
    del aaa16["Unnamed: 3"]
...
upto2016.to_csv("/home/mint/my-data/Web_scraped_CPI/Code_upgrade/data/unitdoublechaineditemlevel.csv")